...
const SearchableMaze: React.FC<SearchableMazeProps> = ({ maze, worklist, currentSearch, searchParents, searchResult, setSearchResult, player, playerFound, target, setTimeoutId, cellDim}) => {
  ...
  }, [worklist, currentSearch, searchResult, maze, target, searchParents, searchLevel, setTimeoutId, setSearchResult])

  useEffect(() => {
    setSearchResult(() => { return { found: new Map<number, number>(), path: new Map<number, number>() }});
